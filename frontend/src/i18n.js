...
const STRINGS = {
  es: {
    ...
    home: 'Inicio', preguntas: 'Empieza aquí: 10 preguntas', tuvida: 'El Perú de tu vida', adivina: 'Adivina el Perú', ficha: 'Ficha departamental', midistrito: 'Mi distrito', comparar: 'Comparar departamentos',
  ...
  en: {
    ...
    home: 'Home', preguntas: 'Start here: 10 questions', tuvida: 'Peru in your lifetime', adivina: 'Guess Peru', ficha: 'Region profile', midistrito: 'My district', comparar: 'Compare regions',
