...
const STRINGS = {
  es: {
    ...
    story4: 'La historia en cuatro gráficos', panorama: 'Panorama nacional · dos décadas de cambio',
  ...
  en: {
    ...
    story4: 'The story in four charts', panorama: 'National panorama · two decades of change',
