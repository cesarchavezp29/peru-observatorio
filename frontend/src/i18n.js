...
const STRINGS = {
  es: {
    ...
    hist_pobreza: 'Historia: la pobreza', hist_desigualdad: 'Historia: la desigualdad', hist_voto: 'Historia: el voto', movilidad: 'Movilidad: la herencia educativa', agenda: 'La agenda pendiente',
  ...
  en: {
    ...
    hist_pobreza: 'Story: poverty', hist_desigualdad: 'Story: inequality', hist_voto: 'Story: the vote', movilidad: 'Mobility: inherited education', agenda: 'The pending agenda',
