...
const STRINGS = {
  es: {
    ...
    home: 'Inicio', preguntas: 'Empieza aquí: 10 preguntas', ficha: 'Ficha departamental', midistrito: 'Mi distrito', comparar: 'Comparar departamentos',
  ...
  en: {
    ...
    home: 'Home', preguntas: 'Start here: 10 questions', ficha: 'Region profile', midistrito: 'My district', comparar: 'Compare regions',
